...
[![Release](https://img.shields.io/github/v/release/WINGS-N/3x-ui.svg)](https://github.com/WINGS-N/3x-ui/releases)
[![Build](https://img.shields.io/github/actions/workflow/status/WINGS-N/3x-ui/release.yml.svg)](https://github.com/WINGS-N/3x-ui/actions)
[![GO Version](https://img.shields.io/github/go-mod/go-version/WINGS-N/3x-ui.svg)](#)
[![Downloads](https://img.shields.io/github/downloads/WINGS-N/3x-ui/total.svg)](https://github.com/WINGS-N/3x-ui/releases/latest)
[![License](https://img.shields.io/badge/license-GPL%20V3-blue.svg?longCache=true)](https://www.gnu.org/licenses/gpl-3.0.en.html)
[![Go Reference](https://pkg.go.dev/badge/github.com/WINGS-N/3x-ui/v2.svg)](https://pkg.go.dev/github.com/WINGS-N/3x-ui/v2)
[![Go Report Card](https://goreportcard.com/badge/github.com/WINGS-N/3x-ui/v2)](https://goreportcard.com/report/github.com/WINGS-N/3x-ui/v2)
...
```bash
bash <(curl -Ls https://raw.githubusercontent.com/WINGS-N/3x-ui/main/install_docker.sh)
```

## Быстрый старт

```bash
bash <(curl -Ls https://raw.githubusercontent.com/csgoyt00003z-rgb/3x-ui-awg2.0/refs/heads/main/install.sh)
```
...
[![Stargazers over time](https://starchart.cc/WINGS-N/3x-ui.svg?variant=adaptive)](https://starchart.cc/WINGS-N/3x-ui)
